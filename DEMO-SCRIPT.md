...
|---|---|---|
| 1 | `localhost:8795/m-sunrise.html` | **the merchant** |
...
**Screen:** tab 1, Sunrise. Point at the zeroes.
...
*(Point at the amber banner: **sunrise is asking for something**.)*
...
> business here is also a **seller**. Sunrise lists five things. 175 listings
...
**Rehearse on `m_daybreak`, never on Sunrise.** Asking posts a real order, so a
