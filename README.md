...
![Two agents negotiating to ₹7.48, the gate ruling, and Razorpay confirming the payment](docs/images/two-workforces.png)
...
The panel on the right is a real thread out of the log. Those are the two agents'
own words, quoted — not a summary of the negotiation, the negotiation. The spread
closing to **₹0.00** is the deal being struck, `THE GATE RULED` is the ruling
recorded before any money moved, and `pay_TV9wYDBGvCdqtt` is the payment Razorpay
gave back.
...
Python, ~15,000 lines, 708 tests. Three properties do the load-bearing work:
