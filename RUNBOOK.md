...
.venv/bin/python -m scripts.serve --merchant m_horizon --port 8795   # leave running
```
...
## 7 · LIVE — the empty merchant  (2 min) — dropdown to **Horizon**
...
**Reload the page** — the trade is now on Horizon's rail, and the figures at
...
**Horizon is not empty any more** (you rehearsed on it) — 30 seconds:
