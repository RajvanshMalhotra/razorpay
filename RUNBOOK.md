...
.venv/bin/python -m scripts.serve --merchant m_sunrise --port 8795   # leave running
```
...
## 7 · LIVE — the empty merchant  (2 min) — dropdown to **Sunrise**
...
**Reload the page** — the trade is now on Sunrise's rail, and the figures at
...
**Sunrise is not empty any more** (you rehearsed on it) — 30 seconds:
